Pod::Spec.new do |s|
  ...
  s.source       = { :git => "http://git.luafan.com/lua52.git", :tag => "v0.0.7" }
  s.source_files  = "lua-5.2.4/src/*.{h,c}", "lua52/*.{h,c}"
  s.exclude_files = "lua-5.2.4/src/lua.c", "lua-5.2.4/src/luac.c"
